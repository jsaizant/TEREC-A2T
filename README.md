...
This repository contains the code for our zero-shot evaluation of textual entailment models on temporal relation classification in clinical domain corpora. 
The textual entailment models are from the [Ask2Transformers framework](https://github.com/osainz59/Ask2Transformers) (Sainz, 2021b) and the code is based on the work from Sainz et al. (2021b). 

## Paper poster 

This poster was presented at the Faculty of Informatics of the University of the Basque Country (UPV/ EHU) on June 3rd 2022 as a final project for the Language Analysis and Processing Master's degree. 
